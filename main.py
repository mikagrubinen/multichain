...
data = {'username':'nisc', 'wallet':'14yd6', 'email':'nisc@nisc.com'}
data1 = {'balance' : 65}
username = 'miro'
...
# adds newely created hex to user-key stream and publish all other data to main stream
a = do.add_new_user(blockchain, stream_name, data)
print(a)

# to retrieve unique key based on username (after login)
# print(do.get_user_key(username))
...
# this publishes hex_value to the user-key stream with key0
